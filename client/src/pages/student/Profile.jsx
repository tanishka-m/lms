...
const Profile = () => {
  ...
  console.log(data);//response from getuserquery
  // const enrolledCourses = [1]; //initially when user is not fetch to design edit profile page
  ...
  const user = data && data.user; //user must logged in
