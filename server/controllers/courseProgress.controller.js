...
export const updatedLectureProgress = async (req, res) => {
    try {
        ...
        //all lecture is complete , filter return array ,contain lec whose viewed true
...
export const markAsCompleted = async (req, res) => {
    try{
        ...
        courseProgress.lectureProgress.map((lectureProgress) => lectureProgress.viewed = true); //setting all lec viewed
        courseProgress.completed = true; //course is completed all lec done
        await courseProgress.save();
...
export const markAsInCompleted = async (req, res) => {
    try{
        ...
        courseProgress.lectureProgress.map((lectureProgress) => lectureProgress.viewed = false); //setting all lec viewed
        courseProgress.completed = false; //course is completed all lec done
        await courseProgress.save();
