...
const Navbar = () => {
    //const user = true; static user for initial test/work
    const { user } = useSelector(store => store.auth);
    //console.log(user); verify user is fetching from store or not
    ...
    return (
        <div className='h-16 dark:bg-[#020817] bg-white border-b dark:border-b-gray-800 border-b-gry-200 fixed top-0 left-0 right-0 duration-300 z-10'>
            {/* Desktop */}
            <div className="max-w-7xl mx-auto hidden md:flex justify-between items-center gap-10 h-full">
                ...
                <div className='flex items-center gap-8'>
                    {/* only load when we have user loggedin */}
                    {
                        user ? (
                            <DropdownMenu>
